...
from routes.prompt_template.prompt_template_controller import prompt_template_workflow
...
app.register_blueprint(prompt_template_workflow, url_prefix="/backend/templates")
