...
def transform_response(full_json: Dict[str, Any], partial_json: Dict[str, Any]) -> str:
    ...
    return json.dumps(flatten(full_json, partial_json))
...
# filtered_json = transform_x(full_json, partial_json)
