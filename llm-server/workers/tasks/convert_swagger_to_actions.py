...
def process_swagger_file(chatbot: Chatbot):
    ...
    try:
        ...
        for action in actions:
            if not action_exists(bot_id, action.operation_id):
...
def action_exists(bot_id: str, operation_id: str) -> bool:
    """
    ...
    return find_action_by_method_id_and_bot_id(bot_id=bot_id, operation_id=operation_id)  # Placeholder return
