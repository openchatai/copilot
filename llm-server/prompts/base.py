...
def non_api_base_prompt(initial_prompt, text):
    return [
...
def api_base_prompt(initial_prompt, text, api_json_output):
    return [
        SystemMessage(content=initial_prompt +
        ...
        SystemMessage(content="Based on the previous user question and chat context, AI helpful answer in markdown: "),
    ]
