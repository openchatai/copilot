...
export const ASIDE_ACTION_DRAGGABLE_ID_REGEX = new RegExp(`^${ASIDE_ACTION_DRAGGABLE_ID_PREFIX}`);
export const BLOCK_ACTION_DRAGGABLE_ID_REGEX = new RegExp(`^${BLOCK_ACTION_DRAGGABLE_ID_PREFIX}`);