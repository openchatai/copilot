---
title: "Get Alerts"
api: "GET https://api-v2.opencopilot.so/reports/:copilotId/insights/alerts"
...
```bash cURL
curl --location --request GET 'https://api-v2.opencopilot.so/reports/abc123/insights/alerts?startDate=2023-01-01T00:00:00Z&endDate=2023-12-31T23:59:59Z' \
...
const options = {
  method: 'GET',
  url: 'https://api-v2.opencopilot.so/reports/abc123/insights/alerts',
  params: {
