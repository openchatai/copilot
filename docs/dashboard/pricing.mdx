...
Once you subscribe to Open, you will have access to the full software. Nothing will be locked behind a paywall, so you won't need to think twice about new features.
  ...
  <Accordion title="Only one plan">
    We have only one plan: a fixed platform fee of $499 per month for unlimited users. Usage is based on our "Pay as you get value" model.
  </Accordion>  
...
You will pay **$499 per month** for unlimited users. Usage is based on our **"Pay as you get value"** model, which is explained below.
