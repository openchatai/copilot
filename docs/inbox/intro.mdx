...
**(_Everything is in single place, no matter what channel you are using - email, chat, phone, etc_)**

Inbox is a centralized place to view, manage and take action on your customer support conversations acroess all your channels (email, chat, phone, etc).
