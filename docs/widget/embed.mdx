...
<CardGroup cols={2}>
  <Card title="As a JavaScript File" href='#using-simple-js-script-recommended' icon="js"> </Card>
...
| `components`      | List of components that will be used to render any UI component. [learn more about responding with UI](/widget/not-gen-ui) | `string` |
