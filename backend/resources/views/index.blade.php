    ...
    <div
        ...
        <div class="absolute pointer-events-none" aria-hidden="true">
            <svg width="512" height="512" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle style="mix-blend-mode:overlay" cx="588" cy="650" r="256" transform="translate(-332 -394)"
                        fill="url(#ill-a)" fill-rule="evenodd" opacity=".48"></circle>
            </svg>
        </div>
        <!-- Illustration -->
        <div class="absolute pointer-events-none" aria-hidden="true">
        ...
        <div class="relative w-full max-w-2xl mx-auto text-center">
            <div class="mb-5">
                <h1 class="text-2xl md:text-3xl text-white font-bold">👋 Welcome to OpenCopilot!</h1>
            </div>
        </div>
    </div>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">My Copilots ✨</h1>
            </div>

            <!-- Right: Actions -->
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                <!-- Create campaign button -->
                <a href="{{route('onboarding.001-step-welcome')}}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                    <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                        <path
                            d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z"></path>
                    </svg>
                    <span class="hidden xs:block ml-2">Create co-pilot</span>
                </a>
            </div>
                ...
                <div class="text-center px-4">
                    <div
                        ...
                        <svg class="w-5 h-6 fill-current" viewBox="0 0 20 24">
                            <path class="text-slate-500"
                                  d="M10 10.562l9-5-8.514-4.73a1 1 0 00-.972 0L1 5.562l9 5z"></path>
                            <path class="text-slate-300"
                                  d="M9 12.294l-9-5v10.412a1 1 0 00.514.874L9 23.294v-11z"></path>
                            <path class="text-slate-400"
                                  d="M11 12.294v11l8.486-4.714a1 1 0 00.514-.874V7.295l-9 4.999z"></path>
                        </svg>
                    </div>
                    <h2 class="text-2xl text-slate-800 font-bold mb-2">Create your first chatbot!</h2>
                    <div class="mb-6">
                        creating a chatbot is easy, just click the button below and follow the steps.
                    </div>
                    <a href="{{route('onboarding.001-step-welcome')}}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                        <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                            <path
                    ...
                    <div class="flex flex-col h-full p-5">
                        <header>
                            <div class="flex items-center justify-between">
                                <div
                                    class="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-rose-500">
                        ...
                        <div class="grow mt-2">
                            <a class="inline-flex text-slate-800 hover:text-slate-900 mb-1"
                               href="{{route('chatbot.settings-theme', ['id' => $bot->getId()->toString()])}}">
                            ...
                            <div class="flex justify-between items-center">
                                <div>
                                    <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600"
                                       href="{{route('chatbot.settings-theme', ['id' => $bot->getId()->toString()])}}">Open
                                        -&gt;</a>
                                </div>
                            </div>
                        </footer>
